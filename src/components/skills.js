...
const skills = () => {
  return (
    <div className='pb-12 md:min-h-screen skillspage font-kalam  ' id='Skills'>
    <div className='text-3xl pt-20 lg:pt-24 lg:p-3 lg:text-6xl md:text-5xl pt-4 text-yellow-500 text-center font-semibold '>Technical Skills</div>
        <div className='flex flex-row flex-wrap bg-white lg:flex-row justify-center  sm:justify-center border-t-8 border-x-4 border-b-2 mx-2 rounded-xl border-yellow-300 lg:mx-10 md:mx-4 pb-2 lg:py-14'>
            <div className=' w-14 lg:w-32 md:w-28 bg-slate-400  mx-3 my-5 shadow-md  hover:shadow-lg hover:shadow-yellow-400 transition duration-500 transform hover:-translate-1 hover:scale-110'> 
            ...
            <div className='w-14 lg:w-32 md:w-28 bg-white  mx-3 my-5 shadow-md  hover:shadow-lg hover:shadow-yellow-400 transition duration-500 transform hover:-translate-1 hover:scale-110'> 
