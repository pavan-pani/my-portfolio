...
const frontpage = () => {
  ...
  return (
    <div className=' min-h-screen frontpage'>
        <div className='grid grid-cols-1 md:grid-cols-2 '>
            <div className="justify-end p-10 sm:p-[140px] md:p-14 md:pt-24 lg:m-20 lg:pl-32 rounded-full pt-20 transition duration-700 transform hover:-translate-1 hover:scale-110 ">
                ...
                <div className='justify-center lg:py-56 text-start mx-6 lg:ml-0 md:py-32 font-kalam'>
                    ...
                    <button className='outline-dotted outline-2 outline-pink-600 text-gray-300 hover:text-black text-2xl py-2 px-4 rounded-lg inline-flex items-center mt-3 hover:bg-pink-600 transition duration-300 transform hover:-translate-1 hover:scale-110' 
